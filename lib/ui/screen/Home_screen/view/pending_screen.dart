...
class _PendingScreenState extends State<PendingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //     body: GetBuilder(
      //   builder: (HomeController homeController) {
      //     return homeController.travelPlansData.isNotEmpty
      //         ? PaginationView(
      //             key: homeController.pendingKey,
      //             scrollDirection: Axis.vertical,
      //             physics: const AlwaysScrollableScrollPhysics(),
      ...
      //                 please: homeController.travelPlansData[index].name,
      //                 price:
      //                     homeController.travelPlansData[index].price.toString(),
      //                 pleaseDetail:
      ...
      //   },
      // )
    return Scaffold(floatingActionButton: GetBuilder(
      builder: (HomeController homeController) {
        return homeController.travelPlansData.isEmpty
            ? GestureDetector(
                onTap: () {
      ...
      builder: (HomeController homeController) {
        return
            // homeController.travelPlansData.isNotEmpty
            //   ?
            PaginationView(
          key: homeController.pendingKey,
          scrollDirection: Axis.vertical,
