            ...
            child: Column(
              ...
              children: [
                ListView.builder(
                    ...
                    itemCount: addCardController.cardData?.lastDigitsOfCard
                            .toString()
                            .length ??
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  "XXX-XXX-XXX-${addCardController.cardData?.lastDigitsOfCard.toString() ?? "1010"}",
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                print("DemoDemoDemo");
                                addCardController.removeATMCard();
                              },
                              child: const Text(
                                "Remove Card",
                                style: TextStyle(
